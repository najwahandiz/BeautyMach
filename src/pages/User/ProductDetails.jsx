...
import { ArrowLeft, ShoppingBag, Star, Sparkles, Droplets, Package, Truck, Shield, Plus, Minus } from 'lucide-react';
...
export default function ProductDetails() {
  ...
  const handleIncrease = () => {
    ...
    else dispatch(increaseQuantity(product.id));
  };
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#fffaf5] to-[#fff5ee] text-[#9E3B3B] text-sm font-medium rounded-xl border border-[#9E3B3B]/10">
                    {(product.skinType || '').charAt(0).toUpperCase() + (product.skinType || '').slice(1)} Skin
                  </span>
                </div>
              </div>
            )}
